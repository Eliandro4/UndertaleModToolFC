...
if(AutoImport)
{
	...
	//var code = Data.GameObjects.ByName("obj_time").EventHandlerFor(EventType.Create, 4, Data);
	var code = "gml_Object_obj_time_Create_0";
	...
	importGroup.QueueReplace(code, obj_time_code);
	importGroup.Import();
